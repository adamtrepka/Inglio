  ...
  return (
    <div className="grid grid-cols-1 gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Phrasal Verbs Exercise Card (Placeholder for future implementation) */}
        <div className="bg-[#121212] rounded-xl p-5 border border-amber-900/50 hover:border-amber-700/50 transition-all animate-slide-up" style={{animationDelay: '400ms'}}>
          <div className="flex items-start gap-4">
            <div className="h-10 w-10 rounded-full bg-amber-600/20 flex-shrink-0 flex items-center justify-center">
            ...
            <div>
              <h4 className="font-medium text-lg">Phrasal Verbs</h4>
              <p className="text-gray-400 text-sm mb-3">Learn common phrasal verbs used in the article through interactive exercises</p>
              <div className="text-amber-400/50 text-sm font-medium flex items-center gap-1">
                Coming Soon
              </div>
            </div>
          </div>
