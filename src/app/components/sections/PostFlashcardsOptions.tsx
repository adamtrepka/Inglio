    ...
    <div className="animate-slide-up">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center">
          <div className="relative h-6 w-6 bg-green-500 rounded-full flex items-center justify-center">
      ...
      <div className="bg-[#121212] rounded-xl overflow-hidden mb-6">
        <div className="p-6">
          <div className="flex items-center mb-6">
            <div className="h-12 w-12 rounded-full bg-indigo-600/30 flex items-center justify-center mr-4">
          ...
          <div className="flex items-center justify-between bg-white/5 rounded-lg p-4 mb-4">
            <div className="flex items-center">
              ...
              <span className="text-sm font-medium">5 of 5 cards complete</span>
            </div>
            <div className="text-sm text-green-500">+50 XP</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="text-left">
              <span className="block font-semibold">Grammar Practice</span>
              <span className="text-xs text-indigo-200">Continue to grammar exercises</span>
            </div>
          </div>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="text-left">
              <span className="block font-semibold">Read Article</span>
              <span className="text-xs text-gray-400">Go to the original article</span>
            </div>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            <path fillRule="evenodd" d="M12.97 3.97a.75.75 0 011.06 0l7.5 7.5a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 11-1.06-1.06l6.22-6.22H3a.75.75 0 010-1.5h16.19l-6.22-6.22a.75.75 0 010-1.06z" clipRule="evenodd" />
        ...
        <button 
          ...
          className="mt-2 py-3 px-6 rounded-full border border-white/10 text-white flex items-center justify-center"
        >
          Back to Home
        </button>
      </div>
